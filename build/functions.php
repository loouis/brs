...
if (function_exists('add_theme_support'))
{
    ...
    add_image_size('m_split-screen-image', 900, 1016, true);
...
function jobs()
{
    ...
    register_post_type('jobs', // Register Custom Post Type
        array(
        'labels' => array(
            'name' => __('Jobs', 'jobs'), // Rename these to suit
            'singular_name' => __('job', 'jobs'),
            'add_new' => __('Add New', 'jobs'),
            'add_new_item' => __('Add New Project', 'jobs'),
            'edit' => __('Edit', 'jobs'),
            'edit_item' => __('Edit Project', 'jobs'),
            'new_item' => __('New HTML5 Blank Custom Post', 'jobs'),
            'view' => __('View HTML5 Blank Custom Post', 'jobs'),
            'view_item' => __('View HTML5 Blank Custom Post', 'jobs'),
            'search_items' => __('Search jobs Post', 'jobs'),
            'not_found' => __('No jobs Posts found', 'jobs'),
